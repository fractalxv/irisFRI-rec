<!DOCTYPE html>
<!--
Laboratory Recruitment and Training Management System
...
This is part of project so that i can have enough money to marry Agnes Ariefiany :D
 ______                    ______                                                                   
(_____ \                  / _____)                                     _                            
	...
	<body>
		<div id="wrapper">
			<nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
				...
				<?php $this->load->view('xrossbone/topnav'); ?>
				<?php $this->load->view('xrossbone/navigation'); ?>
			</nav>
			<div id="page-wrapper">
				<div class="row">
