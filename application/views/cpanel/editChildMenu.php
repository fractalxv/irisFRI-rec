					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div id="stream_list">
						<?= form_open('cpanel/requestEditChildMenu/');?>
							...
							<div class="form-group">
                                ...
                                <input class="form-control"   maxlength="50" required readonly value="<?=$pmn->menu_name?>">
								<input class="form-control"  type="hidden" name="pid" value="<?=$pmn->id?>">
								<p class="help-block">Nama Parent</p>
                            </div>
							<div class="form-group">
                                <label>Nama Menu</label>
                                <input class="form-control"  name="mname" maxlength="50" required value="<?=$mn->menu_name?>">
								<input class="form-control"  type="hidden" name="id" value="<?=$mn->id?>">
							...
							<div class="form-group">
                                ...
                                <select data-placeholder="Module" name="md" class="form-control chosen-select" tabindex="2" required>
									<option value="<?=$mn->id_pm?>"><?=$mn->module_name?></option>
									<?php
									foreach($md as $a){
										if($a->id_pm != $mn->id_pm){
									?>	
							...
							<div class="form-group">
                                ...
                                <input class="form-control"  name="url" maxlength="50" required value="<?=$mn->url?>">
